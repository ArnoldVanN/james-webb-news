			...
			render={(data) => (
				<section id="newsSection">
					...
					<div id="newsFeed">
						...
						<ul>
							<p>
								Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem modi fugit, aspernatur
								necessitatibus eligendi veritatis quas fuga quasi dicta doloremque odit molestias omnis.
								Libero, amet quos? Nisi nobis architecto sed.
							</p>
